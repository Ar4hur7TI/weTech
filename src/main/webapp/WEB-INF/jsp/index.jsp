...
<div class="holder">
    ...
    <div style="display: flex; justify-content: center; padding:20px">
        ...
        <a href="javascript:void(0)"><div id="eng" style="font-size: 18px; padding: 0 10px 0 10px;" class="enable">English</div></a>
        <a href="javascript:void(0)"><div id="french" style="font-size: 18px; padding: 0 10px 0 10px;" class="disabled">Français</div></a>
    </div>
    <div>
  <span id="hotmail" style="justify-content: center; padding: 0; font-size: 18px; color:#000000; text-decoration: none;">
    PS: I love you. Get your free live-event transcription at
  </span>
        <a href="https://conferencecaptioning.com/?src=wetech" style="justify-content: center; padding: 0; font-size: 18px; text-decoration:underline;color:#0000ff;">
